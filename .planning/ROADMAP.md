...
- Letter-suffix phases (2b, 3b, 3c): Urgent insertions / execution-precision sub-phases

- [x] **Phase 1: Walking Skeleton** - Camera-as-canvas HUD shell with mock TxLine and 3 neon widgets
- [x] **Phase 2: Live Data** - Replace mock with real TxODDS API; match selection; service worker
- [x] **Phase 2b: Fix Dynamic HUD Routing and SSE Connection** - Urgent fix for HUD routing and SSE data connection (INSERTED)
- [x] **Phase 3b: Devnet Blink Hedge** - Solana Action endpoint + risk engine + WalletProvider
- [x] **Phase 3c: Submission Polish** - UI fixes from feedback, Blinks Inspector validation, judge packet
- [x] **Phase 4: Real SPL Hedge** - Upgrade SystemProgram breadcrumb to real SPL vault instruction
...
- [x] 03c-01: Render deployment + UI polish + judge packet (commits `2bfae57`..`3d4bb73`)
...
- [x] 02-01: Data Layer Foundation — config, auth, SSE source, adapter, app state machine, provider
- [x] 02-02: Service Worker — serwist install, offline shell, update banner, layout integration
- [x] 02-03: UI Components — MatchSelector, ApiStatusIndicator, DataErrorBanner, page.tsx integration

### Phase 2b: Fix Dynamic HUD Routing and SSE Connection (INSERTED)
...
- [ ] TBD (run /gsd-plan-phase 2b to break down)
...
**Success Criteria** (what must be TRUE):
   ...
   2. CI gates every PR against the 82 unit tests + typecheck
...
- [x] 04-01: SPL vault + transaction builder + SPL env config + CI update
...
| 3c. Submission Polish | 1/1 | Complete | 2026-07-09 |
| 2. Live Data | 3/3 | Complete | 2026-07-09 |
| 4. Real SPL Hedge | 1/1 | Complete | 2026-07-09 |

### Phase 2b: Fix Dynamic HUD Routing and SSE Connection
